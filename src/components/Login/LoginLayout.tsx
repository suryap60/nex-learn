...
const LoginLayout: React.FC<LoginLayoutProps> = ({ children }) => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[url('/assets/images/login/background-image.jpg')] bg-fixed bg-cover bg-center p-5 font-inter">
      <div className="flex w-full max-w-[1000px] bg-[#2d3e4e] rounded-[24px] overflow-hidden shadow-2xl relative min-h-[600px] p-1 md:p-1.5 lg:p-2">
        {/* Left Sidebar */}
        <div className="hidden md:flex flex-[0.8] p-10 lg:p-12 flex-col justify-between items-center text-white relative">
        ...
        <div className="flex-1 my-1.5 mr-1.5 md:my-3 md:mr-3 bg-white rounded-[20px] p-10 md:p-16 flex flex-col relative">
          {children}
        </div>
      </div>
    </div>
